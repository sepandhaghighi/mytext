...
README_ITEMS = [
    "[Version {0}](https://github.com/sepandhaghighi/mytext/archive/v{0}.zip)",
    "pip install mytext=={0}"]

SETUP_ITEMS = [
    "version='{0}'",
    "https://github.com/sepandhaghighi/mytext/tarball/v{0}"]

CHANGELOG_ITEMS = [
    "## [{0}]",
    "https://github.com/sepandhaghighi/mytext/compare/v{0}...dev",
    "[{0}]:"]

PARAMS_ITEMS = ['MY_TEXT_VERSION = "{0}"']
ISSUE_TEMPLATE_ITEMS = ["- MyText {0}"]
