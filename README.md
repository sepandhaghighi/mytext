...
> Latest real API integration test results 

| Provider | Status |
|---|---|
| AI Studio | ![](https://img.shields.io/github/actions/workflow/status/sepandhaghighi/mytext/api-ai-studio.yml?branch=main&style=for-the-badge&logo=googlecloud&label=AI%20Studio) |
| Cloudflare | ![](https://img.shields.io/github/actions/workflow/status/sepandhaghighi/mytext/api-cloudflare.yml?branch=main&style=for-the-badge&logo=cloudflare&label=Cloudflare) |
| OpenRouter | ![](https://img.shields.io/github/actions/workflow/status/sepandhaghighi/mytext/api-openrouter.yml?branch=main&style=for-the-badge&logo=openai&label=OpenRouter) |
| Cerebras | ![](https://img.shields.io/github/actions/workflow/status/sepandhaghighi/mytext/api-cerebras.yml?branch=main&style=for-the-badge&logo=cerebras&label=Cerebras) |
| Groq | ![](https://img.shields.io/github/actions/workflow/status/sepandhaghighi/mytext/api-groq.yml?branch=main&style=for-the-badge&logo=groq&label=Groq) |
| NVIDIA | ![](https://img.shields.io/github/actions/workflow/status/sepandhaghighi/mytext/api-nvidia.yml?branch=main&style=for-the-badge&logo=nvidia&label=NVIDIA) |
| GitHub Models | ![](https://img.shields.io/github/actions/workflow/status/sepandhaghighi/mytext/api-github.yml?branch=main&style=for-the-badge&logo=github&label=GitHub%20Models) |
